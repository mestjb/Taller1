...
public class Ventana extends JFrame {
    ...
    */
    ...
    //Profe no caché la sintaxis para darle la funcionalidad a los botones :(
    
    /* Boton Agregar informacion

        try {
            String nombre = capturarError(this.nombreTF.getText());  
            String mntricula = capturarError(this.matriculaTF.getText());  
            String carrera = capturarError(this.carreraTF.getText());
            String correo = capturarError(this.correoTF.getText());
    
            Estudiante estudiante=new Estudiante (nombre,matricula,carrera,correo);  
    ...
    */
    ...
    /*  Boton Limpiar Textfields
    
    public void vaciar(){  //Metodo limpiar textfields
        this.nombreTF.setText("");
        this.matriculaTF.setText("");
        this.carreraTF.setText("");  
